...
//        header.setPrefHeight(76);
		...
		HBox btnRow = new HBox(10, quickActionBtn("Book Now", () -> innerPane.show("reservation")),
		...
		HBox summaryRow = new HBox(10, summaryCard("Total Trips", lblTotalTrips),
				summaryCard("Completed", lblCompleted), summaryCard("Pending", lblPending),
		...
		TableView<Object[]> table = FxUtil.buildTable("Trip ID", "Vehicle", "Destination", "Start Date", "End Date",
				"Status");
	...
	private VBox summaryCard(String title, Label value) {
		VBox p = new VBox(4);
		p.setStyle("-fx-background-color:#0096C7;-fx-background-radius:15px;"
	...
	private void loadDashboard() {
		try {
			...
			while (r3.next()) {
				tableData.add(new Object[] { r3.getInt(1), r3.getString(2), r3.getString(3), r3.getDate(4),
